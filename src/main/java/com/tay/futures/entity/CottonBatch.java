...
public class CottonBatch implements Serializable {
    ...
    public void setJiagongleixing(String jiagongleixing) {
        this.jiagongleixing = jiagongleixing == null ? null : jiagongleixing.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", length32=").append(length32);
        sb.append(", length31=").append(length31);
        sb.append(", length30=").append(length30);
        sb.append(", length29=").append(length29);
        sb.append(", length28=").append(length28);
        sb.append(", length27=").append(length27);
        sb.append(", length26=").append(length26);
        sb.append(", length25=").append(length25);
        sb.append(", micronaireC1=").append(micronaireC1);
        sb.append(", micronaireB1=").append(micronaireB1);
        sb.append(", micronaireA=").append(micronaireA);
        sb.append(", micronaireB2=").append(micronaireB2);
        sb.append(", micronaireC2=").append(micronaireC2);
        sb.append(", huichao=").append(huichao);
        sb.append(", strengthMax=").append(strengthMax);
        sb.append(", strengthMin=").append(strengthMin);
        sb.append(", evennessMax=").append(evennessMax);
        sb.append(", evennessMin=").append(evennessMin);
        sb.append(", weightGross=").append(weightGross);
        sb.append(", weightTare=").append(weightTare);
        sb.append(", weightNet=").append(weightNet);
        sb.append(", weightConditoned=").append(weightConditoned);
        sb.append(", jiagongleixing=").append(jiagongleixing);
