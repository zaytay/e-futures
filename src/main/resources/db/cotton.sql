...
CREATE TABLE `ratio_strategy` (
  `id` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `template_id` bigint(10)  NOT NULL COMMENT '所属模板ID',
  `colour_w1` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '白棉1',
  `colour_w2` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '白棉2',
  `colour_w3` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '白棉3',
  `colour_w4` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '白棉4',
  `colour_w5` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '白棉5',
  `colour_l1` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '淡棉1',
  `colour_l2` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '淡棉2',
  `colour_l3` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '淡棉3',
  `colour_ly1` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '淡黄1',
  `colour_ly2` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '淡黄2',
  `colour_ly3` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '淡黄3',
  `colour_y1` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '黄染1',
  `colour_y2` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '黄染2',
  `ginning_p1` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '轧工  P1',
  `ginning_p2` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '轧工  P2',
  `ginning_p3` double(12,5)  NOT NULL DEFAULT '0.00000' COMMENT '轧工  P3',
  `create_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ;
